"""OGLE-KOI Dual Strategy - Combined Backtest for USDCHF
=======================================================
ASSET: USDCHF 5M
TIMEFRAME: 5 minutes
...
STRATEGY 1 - KOI:
- Bullish Engulfing + 5 EMAs ascending + CCI > 100 + Breakout Window
- SL: 3.0x ATR, TP: 12.0x ATR
- SL Filter: 10.5-14.5 pips

STRATEGY 2 - OGLE:
- EMA Crossover + Pullback + Volatility Expansion Channel
- SL: 2.5x ATR, TP: 10.0x ATR
- Time Filter: 07:00-13:00 UTC
...
# =============================================================================
# KOI STRATEGY (from koi_usdchf_pro.py)
# =============================================================================
...
try:
    from sunrise_ogle_usdchf_pro import SunriseOgle as OGLEStrategyBase
    OGLE_AVAILABLE = True
...
def aggregate_results(results_list, starting_cash):
    ...
    print(f"\n" + "=" * 70)
    print(f"=== OGLE-KOI DUAL STRATEGY SUMMARY ===")
    print(f"=" * 70)
...
def create_portfolio_charts(results_list, starting_cash):
    ...
    fig.suptitle('OGLE-KOI Multi-Strategy Backtest (USDCHF 5M)', 
...
def run_dual_strategy_backtest():
    ...
    print(f"=== OGLE-KOI DUAL STRATEGY BACKTEST ===")
